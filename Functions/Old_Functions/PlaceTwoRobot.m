  ...
  %  LeftRobot.base=transl(BaseLeft(1:3))* trotx(BaseLeft(4))* troty(BaseLeft(5))* trotz(BaseLeft(6));
    ...
    switch opt.visual
        ...
        case 'Human'
            ...
            LeftRobot.plot(qsL,'nowrist','noname','shading','noshadow','nobase','jointcolor','g','tile1color',[1 1 1] ); % 'jointdiam',0.1,
            hold on

            qsR = [0*deg 0*deg 0 pi/2 0];
            RightRobot.name = 'RightArm';
            RightRobot.plot(qsR,'nowrist','noname','shading','noshadow','nobase','jointcolor','g','tile1color',[1 1 1] );
            hold on
